...
import ColorPicker, { BlueSlider, ColorFormatsObject, GreenSlider, OpacitySlider, PreviewText, RedSlider } from "reanimated-color-picker";
...
export default function ColorPickers({kind, currentColor, onColorPick}: ColorPickersProps){
          ...
          >
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <View style={{ alignItems: 'center' }}>
                ...
                <RedSlider style={Styles.ColorPicker.sliderVerticalStyle} vertical reverse />
              </View>

              <View style={{ alignItems: 'center' }}>
                <Text style={Styles.ColorPicker.sliderTitle}>G</Text>
                <GreenSlider style={Styles.ColorPicker.sliderVerticalStyle} vertical reverse />
              </View>

              <View style={{ alignItems: 'center' }}>
                <Text style={Styles.ColorPicker.sliderTitle}>B</Text>
                <BlueSlider style={Styles.ColorPicker.sliderVerticalStyle} vertical reverse />
              </View>

              <View style={{ alignItems: 'center' }}>
                <Text style={Styles.ColorPicker.sliderTitle}>A</Text>
                <OpacitySlider style={Styles.ColorPicker.sliderVerticalStyle} vertical reverse />
              </View>
            </View>
