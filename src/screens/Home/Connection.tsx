...
export default function App() {
     ...
     <Modal
      ...
      >
        <TouchableOpacity style={Styles.Modal.modalOverlay} onPress={() => setModalVisible(false)}>
          {ips.length <= 0 && <LottieView source={LottieLoading} autoPlay loop style={{width: 100, height: 100}}/>}
  ...
  return (
      <View style={Styles.Main.container}>
        ...
        <Button buttonStyle={Styles.Main.button} title="Find Beefweb Servers" onPress={findBeefwebServers} />
        {modal(scannedIps)}
      </View>
  );
}
